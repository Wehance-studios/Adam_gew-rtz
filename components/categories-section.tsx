...
const categories = [
  ...
  {name: 'Herbs', image: '/images/categories/herbs.jpg'},
  {name: 'Blends', image: '/images/categories/blends.jpg'},
  {name: 'Special Mixes', image: '/images/categories/mixes.jpg'},
]
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {categories.map(category => (
            <Link key={category.name} href={`/${locale}/categories`} className="group relative aspect-[3/4] rounded-2xl overflow-hidden">
